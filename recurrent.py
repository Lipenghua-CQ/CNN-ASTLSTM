...
class PLSTMCell(Layer):
    ...
    def __init__(self, units,
                 ...
                 kernel_initializer='glorot_uniform',
                 recurrent_initializer='orthogonal',
                 pf_initializer = 'zeros',
                 pi_initializer='zeros',
                 po_initializer='zeros',
                 bias_initializer='zeros',
                 unit_forget_bias=True,
                 kernel_regularizer=None,
                 recurrent_regularizer=None,
        ...
        self.kernel_initializer = initializers.get(kernel_initializer)
        self.recurrent_initializer = initializers.get(recurrent_initializer)
        self.pf_initializer = initializers.get(pf_initializer)
        self.pi_initializer = initializers.get(pi_initializer)
        self.po_initializer = initializers.get(po_initializer)
        self.bias_initializer = initializers.get(bias_initializer)
        self.unit_forget_bias = unit_forget_bias
    ...
    def build(self, input_shape):
        ...
        ##-----------------------窥视孔权重----------------------------##
        self.pf_kernel = self.add_weight(
            shape=(self.units,),
            name='pf_kernel',
            initializer=self.pf_initializer,
            regularizer=self.bias_regularizer,
            constraint=self.bias_constraint)

        self.pi_kernel = self.add_weight(
            shape=(self.units,),
            name='pi_kernel',
        ...
        self.po_kernel = self.add_weight(
            shape=(self.units,),
            name='po_kernel',
            initializer=self.po_initializer,
            regularizer=self.bias_regularizer,
            constraint=self.bias_constraint)
        ##-----------------------窥视孔权重----------------------------##
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            if 0 < self.recurrent_dropout < 1.:
                ...
                h_tm1_o = h_tm1
            i = self.recurrent_activation(x_i + K.dot(h_tm1_i,
                                                      self.recurrent_kernel_i) + c_tm1 * self.pi_kernel)
            f = self.recurrent_activation(x_f + K.dot(h_tm1_f,
                                                      self.recurrent_kernel_f) + c_tm1 * self.pf_kernel)
            c = f * c_tm1 + i * self.activation(x_c + K.dot(h_tm1_c,
                                                            self.recurrent_kernel_c))
            o = self.recurrent_activation(x_o + K.dot(h_tm1_o,
                                                      self.recurrent_kernel_o) + c * self.po_kernel)
        else:
            if 0. < self.dropout < 1.:
                inputs *= dp_mask[0]
            z = K.dot(inputs, self.kernel)
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'kernel_initializer': initializers.serialize(self.kernel_initializer),
                  'recurrent_initializer': initializers.serialize(self.recurrent_initializer),
                  'pf_initializer': initializers.serialize(self.pf_initializer),
                  'pi_initializer': initializers.serialize(self.pi_initializer),
                  'po_initializer': initializers.serialize(self.po_initializer),
                  'bias_initializer': initializers.serialize(self.bias_initializer),
                  'unit_forget_bias': self.unit_forget_bias,
                  'kernel_regularizer': regularizers.serialize(self.kernel_regularizer),
                  'recurrent_regularizer': regularizers.serialize(self.recurrent_regularizer),
...
class PLSTM(RNN):
    ...
    def __init__(self, units,
        ...
        cell = PLSTMCell(units,
                        ...
                        kernel_initializer=kernel_initializer,
                        recurrent_initializer=recurrent_initializer,
                        pf_initializer=pf_initializer,
                        pi_initializer=pi_initializer,
                        po_initializer=po_initializer,
                        unit_forget_bias=unit_forget_bias,
                        bias_initializer=bias_initializer,
                        kernel_regularizer=kernel_regularizer,
                        recurrent_regularizer=recurrent_regularizer,
    ...
    def recurrent_initializer(self):
        return self.cell.recurrent_initializer
    @property
    def pf_initializer(self):
        return self.cell.pf_initializer
    @property
    def pi_initializer(self):
        return self.cell.pi_initializer
    @property
    def po_initializer(self):
        return self.cell.po_initializer
...
##-----------------------窥视孔权重----------------------------##
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            f = self.recurrent_activation(x_f + K.dot(h_tm1_f,
                                                      self.recurrent_kernel_f))
            c = f * c_tm1 + (1-f) * i * self.activation(x_c + K.dot(h_tm1_c,
                                                            self.recurrent_kernel_c))
            o = self.recurrent_activation(x_o + K.dot(h_tm1_o, self.recurrent_kernel_o) + self.ph_kernel * c)
        else:
            if 0. < self.dropout < 1.:
                inputs *= dp_mask[0]
            z = K.dot(inputs, self.kernel)
...
class ATSLSTM(RNN):
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        self.cell._dropout_mask = None
        self.cell._recurrent_dropout_mask = None
        return super(ATSLSTM, self).call(inputs,
                                      mask=mask,
                                      training=training,
                                      initial_state=initial_state)
